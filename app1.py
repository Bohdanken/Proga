...
def alarm_forecast(chosen_region):
    ...
    with open(f"data/predictions/prediction_{chosen_date_string}.pkl", "rb") as f:
...
def calculate():
    ...
    if region == 'All':
        ...
        # with open(f"data/predictions/prediction_{chosen_date_string}.pkl", "wb") as f:
        ...
        # with open(f"data/predictions/prediction_{region}_{chosen_date_string}.pkl", "wb") as f:
...
def get_forecast_for_all():
    ...
    time = chosen_date
    global time_as_path
    time_as_path = path_to_forecasts + \
        str(str(chosen_date.date())+" "+str(chosen_date.hour)+".json",)
